...
export const ProjectCard = ({ id, title, dueDate, users, }) => {
    ...
    return (<ConfigProvider theme={{
            ...
            <Card size="small" title={<Text ellipsis={{ tooltip: title }}>{title}</Text>} onClick={() => {
            edit("tasks", id, "replace");
            ...
            marginRight: "4px",
                ...
                backgroundColor: dueDateOptions.color === "default" ? "transparent" : "unset",
                    ...
                    {!!users?.length && (<Space size={4} wrap direction="horizontal" align="center" style={{
                display: "flex",
                ...
                marginRight: "0",
                            ...
                            {users.map((user) => {
                return (<Tooltip key={user.id} title={user.name}>
