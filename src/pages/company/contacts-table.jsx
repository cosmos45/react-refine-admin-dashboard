...
import { ContactStatusTag } from "@/components/contact_status_tag";
...
export const CompanyContactsTable = () => {
    ...
    return (<Card headStyle={{
            borderBottom: "1px solid #D9D9D9",
            marginBottom: "1px",
        }} bodyStyle={{ padding: 0 }} title={<Space size="middle"><TeamOutlined />
                    <Text>Contacts</Text>
                </Space>} extra={<>
            ...
            showSizeChanger: false,
                ...
                <Table.Column title="Name" dataIndex="name" render={(_, record) => {
            return (<Space>
                ...
                <Table.Column title="Title" dataIndex="jobTitle" filterIcon={<SearchOutlined />} filterDropdown={(props) => (<FilterDropdown {...props}>
                            <Input placeholder="Search Title"/>
                        </FilterDropdown>)}/>
                <Table.Column title="Stage" dataIndex="status" render={(_, record) => {
            return <ContactStatusTag status={record.status}/>;
        }} filterDropdown={(props) => (<FilterDropdown {...props}>
                            <Select style={{ width: "200px" }} mode="multiple" placeholder="Select Stage" options={statusOptions}/>
                        </FilterDropdown>)}/>
                <Table.Column dataIndex="id" width={112} render={(value, record) => {
            return (<Space>
